...
// Copied from https://cs.android.com/androidx/platform/frameworks/support/+/androidx-main:compose/runtime/runtime/src/commonMain/kotlin/androidx/compose/runtime/collection/MutableVector.kt;l=1161;drc=edde6e8b9d304264598f962a3b0e5c267e1373bb

/**
 * A [MutableList]-like structure with a simplified interface that offers faster access than
 * [ArrayList].
 */
public class MutableVector<T> @PublishedApi internal constructor(
   ...
   */
  public inline val lastIndex: Int get() = size - 1

  /**
   * Returns an [IntRange] of the valid indices for this [MutableVector].
   */
  public inline val indices: IntRange get() = 0..size - 1
   ...
   */
  public inline fun <reified R> mapIndexedNotNull(transform: (index: Int, T) -> R?): MutableVector<R> {
    contract { callsInPlace(transform) }
    val size = size
...
public inline fun <reified T> MutableVector(size: Int, noinline init: (Int) -> T): MutableVector<T> {
